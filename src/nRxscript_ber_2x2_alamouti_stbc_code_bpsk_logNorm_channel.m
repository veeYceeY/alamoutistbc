...
function [simBer,Eb_N0_dB,theoryBer_nRx1,theoryBerMRC_nRx2,theoryBerAlamouti_nTx2_nRx1]=nRxscript_ber_2x2_alamouti_stbc_code_bpsk_logNorm_channel(log_mean,log_variance,N,nRx)
...
for ii = 1:length(Eb_N0_dB)
    ...
    nch = 1/sqrt(2)*[logNorm(log_mean,log_variance,N) + j*logNorm(log_mean,log_variance,N)];
    for ki=1:nRx
    h(ki,:)=nch;
    end
